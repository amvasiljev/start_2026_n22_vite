# Vite + Pug + SCSS vite/8.1.3  node-v22.20.0
...
## ⚠️ Важно
При установке используйте --legacy-peer-deps из-за конфликта версий Vite и плагина:

```bash
npm install --legacy-peer-deps
```
Это безопасно и проект будет работать корректно.
